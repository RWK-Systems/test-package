...
namespace TestPackage.Core
{
    ...
    public class ConfigModel
    {
        ...
        public string RegistryEntries { get; set; } = @"HKCU\Software\RWK Systems\TestPackage|InstallDate|REG_SZ|%DATE%,HKCU\Software\RWK Systems\TestPackage|Version|REG_SZ|1.0.0,HKLM\Software\RWK Systems\TestPackage|InstallPath|REG_SZ|%InstallDir%";
        ...
        public string EnvironmentVariables { get; set; } = @"User|TESTPACKAGE_HOME|%InstallDir%,User|TESTPACKAGE_VERSION|1.0.0";
